...
const Login = () => {
  ...
  return (
    <SafeAreaView>
     ...
     Nếu bạn quên mật khẩu vui lòng nhập
     </Text>
     <Text style={{alignSelf:'center',fontSize:14,}}> Email hoặc số điện thoại tại đây để lấy lại</Text>
      ...
      <TouchableOpacity style={styles.login1} onPress = { () => {navigate('OTP')}}>
